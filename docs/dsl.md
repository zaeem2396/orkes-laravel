...
Define Conductor workflows in PHP with a fluent API. Generates Conductor schema version 2 definitions with SIMPLE (worker) tasks. See also [workflow-example.md](workflow-example.md) and [examples/](../examples/).
