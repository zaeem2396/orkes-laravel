...
/**
 * Tests for Conductor::fake() with the Facade (Laravel app). Requires TestCase with ConductorServiceProvider. For direct ConductorFake tests see ConductorFakeTest.
 */
