...
See [docs/ROADMAP.md](docs/ROADMAP.md) for the full implementation roadmap, sub-modules, and status. Phases 1–4 (HTTP client, Workflow client, Task client, Worker system) are complete.
